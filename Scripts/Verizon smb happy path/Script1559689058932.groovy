...
WebUI.openBrowser('fuseapp.staging.clearlink.com')
...
WebUI.click(findTestObject('Page_ Fuse (verizonsmb qa)/label_Yes'))
...
WebUI.click(findTestObject('Verizon SMB Object repo/Page_ Fuse (verizonsmb qa)/button_Create an Additional Order'))

WebUI.delay(2)

WebUI.click(findTestObject('callbacks opps notes create addition yes no/Page_ Fuse (verizonsmb qa)/button_Yes Im sure'))
