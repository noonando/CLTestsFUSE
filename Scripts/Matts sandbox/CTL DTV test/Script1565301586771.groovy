...
WebUI.setText(findTestObject('Matts objects/CTL Addons/Page_ Fuse (Centurylink qa)/input_Addons_el-input__inner'), '08232019')
...
WebUI.click(findTestObject('Matts objects/CTL DTV/Page_ Fuse (Centurylink qa)/span_Yes'))

WebUI.delay(2)

WebUI.setText(findTestObject('Matts objects/CTL DTV/Page_ Fuse (Centurylink qa)/input_DirecTV Billing ID ___BVID__840'), 
    '8975612')

WebUI.setText(findTestObject('Matts objects/CTL DTV/Page_ Fuse (Centurylink qa)/input_DirecTV Pricing ___BVID__843'), '50')

WebUI.click(findTestObject('Matts objects/CTL DTV/Page_ Fuse (Centurylink qa)/button_Open Opus'))

WebUI.verifyAlertNotPresent(5, FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.verifyElementClickable(findTestObject('Matts objects/CTL summary page/Page_ Fuse (Centurylink qa)/a_Status Log'), 
