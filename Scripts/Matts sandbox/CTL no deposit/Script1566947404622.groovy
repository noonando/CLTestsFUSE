...
WebUI.setText(findTestObject('Matts objects/CTL credit check page/Page_ Fuse (Centurylink qa)/input_SSN _order_ssn'), '666827437')
...
WebUI.setText(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/input_First Name _order_billing_first_name'), 
    'DEBORAH')

WebUI.setText(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/input_Last Name _order_billing_last_name'), 
    'HAGENEYER')

WebUI.setText(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/Page_ Fuse (Centurylink qa)/input_Postal Code _customer_addresses_billing_postal_code'), 
    '30327')

WebUI.setText(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/Page_ Fuse (Centurylink qa)/input_Street Address _customer_addresses_billing_line1'), 
    '85 Adrian')

WebUI.selectOptionByIndex(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/Page_ Fuse (Centurylink qa)/select_AlabamaAlaskaArizona'), 
    11)

WebUI.setText(findTestObject('Matts objects/CTL billing address/Page_ Fuse (Centurylink qa)/Page_ Fuse (Centurylink qa)/input_City _customer_addresses_billing_city'), 
    'Atlanta')
