...
WebUI.selectOptionByIndex(findTestObject('Verizon SMB Object repo/Page_ Fuse (verizonsmb qa)/select_Alabama'), 3)
...
WebUI.click(findTestObject('Matts objects/CTL products page/Page_ Fuse (Centurylink qa)/gigabit button'))
